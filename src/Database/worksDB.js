const works = [
	...
	{
		img: "./media/projects-thumbnails/inner-team.jpg",
		name: "inner-team",
		tools: "Tailwind, React.js, Git, GitHub, Vercel, Figma",
		description: 'I was one of the people in charge of the Frontend part of the project for the company, I built all the content starting from the "FAQ Section" and going down. Also all the "Blog".',
		link: "https://inner-team-pi.vercel.app/"
	},

	{
		img: "./media/projects-thumbnails/Pablo-Emmanuel-De-Leo.jpg",
		name: "Pablo",
	...
	{
		img: "./media/projects-thumbnails/Eliana-Moura.jpg",
		name: "Eliana Moura",
